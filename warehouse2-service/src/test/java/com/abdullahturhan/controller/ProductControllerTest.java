...
class ProductControllerTest {
    ...
    void itShouldFindProducts_WhenExistsCategory() throws Exception {
        ...
        // then
        mockMvc.perform(MockMvcRequestBuilders.get("/api/warehouse2/category")
    ...
    void itShould_addProduct_WhenProductDtoValid() throws Exception {
        ...
        // then
        mockMvc.perform(MockMvcRequestBuilders.post("/api/warehouse2/add")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void takeOut() throws Exception {
        ...
        // then
        mockMvc.perform(MockMvcRequestBuilders.post("/api/warehouse2/takeout")
                .contentType(MediaType.APPLICATION_JSON)
                .content(productDtoJson)
